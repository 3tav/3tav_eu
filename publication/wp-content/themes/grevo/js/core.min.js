...
jQuery(window).resize(function(){thsn_img_size_correction()});jQuery(document).ready(function(){thsn_validate();thsn_search_results();thsn_tabs_element();thsn_toggleSidebar();thsn_sorting();thsn_back_to_top();thsn_sticky_header();thsn_navbar();thsn_lightbox();thsn_video_popup();thsn_testimonial();thsn_search_btn();thsn_center_logo_header_class();thsn_selectwrap();thsn_menu_count();setTimeout(function(){thsn_carousel()},500);thsn_img_size_correction();thsn_number_rotate();thsn_sticky_header_class()});jQuery(window).load(function(){thsn_one_page();thsn_one_page_on_scroll();thsn_preloader();thsn_sorting();thsn_gallery();thsn_circle_progressbar();thsn_infinite_scroll()});jQuery(window).on('scroll',function(){thsn_one_page_on_scroll()})